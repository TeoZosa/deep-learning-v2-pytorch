...
__version__ = importlib_metadata.metadata("deep-learning-v2-pytorch")["Version"]
app = typer.Typer()
...
def version_callback(value: Optional[bool]):  # pylint: disable=unsubscriptable-object
    ...
    if value:
        typer.echo(f"deep-learning-v2-pytorch Version: {__version__}")
        raise typer.Exit()
...
if __name__ == "__main__":
    app(prog_name="deep-learning-v2-pytorch")  # pragma: no cover
